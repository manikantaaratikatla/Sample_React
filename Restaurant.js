...
const Restaurant = ({ url }) => {
  ...
  const IMAGE_CDN = "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_208,h_208,c_fit/";
          ...
          const items = allItemCards.map(item => {
            ...
            return {
              ...
              price: info.price
                ...
                : "N/A",
              image: info.imageId
                ? `${IMAGE_CDN}${info.imageId}`
                : "https://via.placeholder.com/208x208.png?text=No+Image",
